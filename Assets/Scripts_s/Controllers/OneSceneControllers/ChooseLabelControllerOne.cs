...
public class ChooseLabelControllerOne : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    public Color defaultColor;
    public Color hoverColor;
    private StoryScene scene;
    private TextMeshProUGUI textMesh;
    private ChooseControllerOne controller;
    ...
    public void Setup(ChooseScene.ChooseLabel label, ChooseControllerOne controller, float y)
    {
